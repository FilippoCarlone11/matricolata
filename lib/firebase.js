...
// AGGIUNTO: Import per Email/Password
import { 
...
export const registerWithEmail = async (name, email, password) => {
  ...
  // 2. Aggiorna Nome Profilo
  await updateProfile(user, { displayName: name });

  // 3. Crea Documento Database
...
// --- NUOVA FUNZIONE: GLOBAL FEED (Aggiunta per la bacheca) ---
export const getGlobalFeed = async () => {
  try {
    ...
    // Fallback se createdAt manca (vecchie versioni)
    let snapshot;
    try {
