...
import { Send, Plus, Zap, Search, Clock, Hourglass, Camera, Loader2 } from 'lucide-react';
      ...
      <div>
        ...
        {filteredList.length === 0 ? (
            ...
            {filteredList.map(c => {
                ...
                return (
                <div key={c.id} className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
                   {/* INFO HEADER */}
                   ...
                   <div className="flex items-center gap-2 border-t pt-3 border-gray-50">
                        ...
                        {/* MODIFICA: Bottone con gradiente Rosso/Arancio */}
                        <button 
